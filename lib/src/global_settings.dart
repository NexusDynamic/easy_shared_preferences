...
class _GlobalSettingsDelegate {
  ...
  static Settings get instance {
    if (_instance == null) {
      throw StateError('GlobalSettings has not been initialized. Call GlobalSettings.initialize() first.');
    }
    return _instance!;
  }
...
class GlobalSettings {
  ...
  static Future<void> initialize(
    ...
    if (_GlobalSettingsDelegate._instance != null) {
      throw StateError('GlobalSettings is already initialized. Call dispose() first if you need to reinitialize.');
    }
    ...
    _logger.info('Initializing GlobalSettings with ${groupConfigs.length} groups');
    ...
    try {
      ...
      if (tempInstance != null) {
        try {
          ...
          _logger.warning('Error disposing partial GlobalSettings initialization', disposeError);
        }
      }
  ...
  static bool getBool(String storageKey) => _GlobalSettingsDelegate.instance.getBool(storageKey);
  static Future<void> setBool(String storageKey, bool value) => _GlobalSettingsDelegate.instance.setBool(storageKey, value);
  static int getInt(String storageKey) => _GlobalSettingsDelegate.instance.getInt(storageKey);
  static Future<void> setInt(String storageKey, int value) => _GlobalSettingsDelegate.instance.setInt(storageKey, value);
  static double getDouble(String storageKey) => _GlobalSettingsDelegate.instance.getDouble(storageKey);
  static Future<void> setDouble(String storageKey, double value) => _GlobalSettingsDelegate.instance.setDouble(storageKey, value);
  static String getString(String storageKey) => _GlobalSettingsDelegate.instance.getString(storageKey);
  static Future<void> setString(String storageKey, String value) => _GlobalSettingsDelegate.instance.setString(storageKey, value);
  static List<String> getStringList(String storageKey) => _GlobalSettingsDelegate.instance.getStringList(storageKey);
  static Future<void> setStringList(String storageKey, List<String> value) => _GlobalSettingsDelegate.instance.setStringList(storageKey, value);
  static T get<T>(String storageKey) => _GlobalSettingsDelegate.instance.get<T>(storageKey);
  static Future<void> set(String storageKey, dynamic value) => _GlobalSettingsDelegate.instance.setValue(storageKey, value);
  static Future<void> setMultiple(Map<String, dynamic> values) => _GlobalSettingsDelegate.instance.setMultiple(values);
  static Future<void> resetSetting(String storageKey) => _GlobalSettingsDelegate.instance.resetSetting(storageKey);
  static Future<void> resetGroup(String groupKey) => _GlobalSettingsDelegate.instance.resetGroup(groupKey);
  static Future<void> resetAll() => _GlobalSettingsDelegate.instance.resetAll();
  static void addChangeCallback(void Function(String key, dynamic oldValue, dynamic newValue) callback) => 
      _GlobalSettingsDelegate.instance.addChangeCallback(callback);
  static bool removeChangeCallback(void Function(String key, dynamic oldValue, dynamic newValue) callback) => 
      _GlobalSettingsDelegate.instance.removeChangeCallback(callback);
  static SettingsGroup getGroup(String groupKey) => _GlobalSettingsDelegate.instance.getGroup(groupKey);
  static bool hasGroup(String groupKey) => _GlobalSettingsDelegate.instance.hasGroup(groupKey);
  static List<String> get groupKeys => _GlobalSettingsDelegate.instance.groupKeys;
}